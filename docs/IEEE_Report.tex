...
To maximize practical fitness utility, the application integrates a muscle group multiselector (Chest, Back, Shoulders, Legs, Biceps, Triceps, Core). The dynamic generator maps the fuzzy outputs (Intensity and Volume) and user-selected goals (Strength, Hypertrophy, Cardio, Recovery) to specific exercises. The physical sets per exercise are scaled dynamically (ranging from 2 to 4 sets) depending on the calculated fuzzy workout volume (duration), establishing a direct linkage between the fuzzy output volume and training workload.
