...
4. **Target Muscle Selection & Dynamic Exercise Generator:** Allows users to select targeted muscle groups (Chest, Back, Legs, etc.) and dynamically maps appropriate exercises, automatically scaling sets (2 to 4 sets) depending on the fuzzy output workout volume.
